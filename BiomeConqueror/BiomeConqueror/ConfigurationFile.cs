        ...
        {
            {
                ...
                bonemassBenefitEnabled = config.Bind<bool>("2 - Victories", "BonemassBenefitEnabled", true, "Disable rain in all swamps after killing Bonemass (default = true)");
                moderBenefitEnabled = config.Bind<bool>("2 - Victories", "ModerBenefitEnabled", true, "Disable freezing in all mountains after killing Moder (default = true)");
